...
fn sanitized_request_string(request: &ConnectionRequest) -> String {
    ...
    format!(
        "\nAddresses: {addresses}{tls_mode}{tls_cert_path}{cluster_mode}{request_timeout}{rfr_strategy}{connection_retry_strategy}{database_id}{protocol}{client_name}{periodic_checks}{pubsub_subscriptions}{inflight_requests_limit}",
    )
}
